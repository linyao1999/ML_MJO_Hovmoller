...
for folder in folder_list:
    ...
    mjo.get_hid_power_norm_ensemble(
        config,
        c=c,
    ...
    feature_path = config['prediction_save_path'].replace('.nc', f'_power_norm_ch{hid_str}_c{c}{reluflg}.nc')
    ...
    out_fn = output_dir + f'/feature_power_norm_{hid_str}_c{c}{reluflg}.nc'
