...
output_path = '/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/filtered/olr.kelvin.k1to10_T3to30.nc'
data = xr.Dataset({'olr': olr_kelvin})
data.to_netcdf(output_path)

print('olr_kelvin output done!')

output_path = '/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/filtered/olr.gravity.T2to3.nc'
...
output_path = '/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/plots/power_spectra_sym_kelvin_k1to10_T3to30.nc'
data = xr.Dataset({'power_sym_kelvin': power_sym_kelvin})
data.to_netcdf(output_path)

output_path = '/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/plots/power_spectra_sym_gravity_T2to3.nc'
