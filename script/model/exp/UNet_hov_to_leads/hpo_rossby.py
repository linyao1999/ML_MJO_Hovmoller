...
base_config["data"]["dataflg"] = "rossby"
base_config["data"]["input_path"] = ["/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/filtered/olrnoaa.rossby.k-1to-10_T10to100.nc",]
base_config["data"]["memory_last"] = 95  
base_config["data"]["lat_range"] = 10
base_config["model"]["name"] = "UNet_A"
base_config["model"]["mlp"]["layer_num"] = 2

# --- store the config under the experiment folder ---
with open(f'hpo_{base_config["data"]["dataflg"]}.yaml', 'w') as f:
...
if __name__ == "__main__":
    ...
    n_parallel = 2  # Number of parallel workers
