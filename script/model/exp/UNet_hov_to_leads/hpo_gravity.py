...
base_config["data"]["dataflg"] = "gravity"
base_config["data"]["input_path"] = ["/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/filtered/olrnoaa.gravity.T2to3.nc",]
