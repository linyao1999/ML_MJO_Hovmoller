...
base_config["data"]["memory_last"] = 29 
base_config["data"]["dataflg"] = 'rossby'
base_config["data"]["input_path"] = '/pscratch/sd/l/linyaoly/MJO_ML_2025/script/model/data/processed/filtered/olr.rossby.k-1to-10_T10to100.nc'
